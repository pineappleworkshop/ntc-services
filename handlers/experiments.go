...
func PSBTFromUnsignedTx(c echo.Context) error {
	...
	psbtHex := "70736274ff0100fd850102000000048bc746a710caaa3b1e294d3a4c6c9d1dd8debf4313d631f8f48cbe1f52c174d301000" +
		"00000ffffffffa8a206c57a58d7a549f0e81213c6c4ae7e57b4e1231d25a7faed3948b3a9f1d00f00000000ffffffff7876ea3af11" +
		"20f5d53e93eb8a033283dd701be3db0595e32908f3e91c933a5460400000000ffffffff8543eb84e01860321a15404d9d04a0d3ade" +
		"15c5bf6c9fb09b0246ee2718f57f30500000000ffffffff052202000000000000225120f4f18b6b4e5de72fab1fc0c95d255c34b13" +
		"3cfae2d33a19fa8798a21e7667bfec303000000000000225120a058c4c973bfe2affd6b83b171ac8d2eda26c43e206053afe46dd4d" +
		"de852d201e8030000000000002251205cba2279dc9a998530a4fe43e78cdbf7793e5371c27877bbca3d5364f4bc1fc636410000000" +
		"00000225120a058c4c973bfe2affd6b83b171ac8d2eda26c43e206053afe46dd4dde852d201022f000000000000225120f4f18b6b4" +
		"e5de72fab1fc0c95d255c34b133cfae2d33a19fa8798a21e7667bfe000000000001012b2202000000000000225120a058c4c973bfe" +
		"2affd6b83b171ac8d2eda26c43e206053afe46dd4dde852d201010842014083afdb354e35a669f554b806c8ed2b56bcae994e3c292" +
		"c687964164770632993a8c6a8b3f0eb5064ecb918d03c7757c899bb0363271c5859235fac5e6d40cc960001012bc30300000000000" +
		"0225120f4f18b6b4e5de72fab1fc0c95d255c34b133cfae2d33a19fa8798a21e7667bfe0001012bb34c000000000000225120a058c" +
		"4c973bfe2affd6b83b171ac8d2eda26c43e206053afe46dd4dde852d20101084201402d91b32a861fa0fc9ed3c68d4a9fbaf6e01ab" +
		"d82cecab1b023fb11652adfa7e46e47b91b389db6335eb0699a1102c3a3151a0e209b8e4b2d275a82ea42f354e10001012b7f3a000" +
		"000000000225120f4f18b6b4e5de72fab1fc0c95d255c34b133cfae2d33a19fa8798a21e7667bfe000000000000"
...
func GeneratePSBT(c echo.Context) error {
	psbt, err := psbt.New(nil, nil, 1, 1, nil)
	if err != nil {
		c.Logger().Errorf("Failed to make empty PSBT: %v", err)
	}

	resp, err := services.BLOCKCHAININFO.GetUTXOsForAddr(
		"bc1p0t40pgryukh88rhwx4ffzt28cjmhxnpm56s3382vyy22zek5wpmq8rps2l",
	)
	if err != nil {
	...
	for _, utxo := range resp {
		body, err := json.MarshalIndent(utxo, "", "  ")
		if err != nil {
	...
	// TODO: convert this list into BciUTXO structs

	return c.JSON(http.StatusOK, psbt)
}
